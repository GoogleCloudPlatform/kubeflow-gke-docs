...
3. Make sure that your Google Cloud project meets the minimum requirements
  described in the [project setup guide](../project-setup/).

4. Follow the guide
  [setting up OAuth credentials](../oauth-setup/)
...
In the [Management cluster deployment](../management-setup/) we created the Google Cloud service account **serviceAccount:kcc-${KF_PROJECT}@${MGMT_PROJECT}.iam.gserviceaccount.com**
...
Refer to [Upgrading Kubeflow cluster](../upgrade#upgrading-kubeflow-cluster).
...
* Learn how to [delete your Kubeflow deployment using the CLI](../delete-cli/).
* To add users to Kubeflow, go to [a dedicated section in Customizing Kubeflow on Google Cloud](../../customizing/#add-users-to-kubeflow).
* To taylor your Kubeflow deployment on Google Cloud, go to [Customizing Kubeflow on Google Cloud](../../customizing/).
* For troubleshooting Kubeflow deployments on Google Cloud, go to the [Troubleshooting deployments](../../troubleshooting/) guide.
