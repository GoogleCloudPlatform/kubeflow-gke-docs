...
1. Click **Create**. A dialog box appears, like the one below:
     ...
     <img src="/{{ .Site.Params.version_url_prefix }}docs/images/new-oauth.png" 
      alt="OAuth consent screen"
      class="mt-3 mb-3 p-3 border border-info rounded">
...
1. On the **Create credentials** screen, find your newly created OAuth 
  credential and click the pencil icon to edit it:
    ...
    <img src="/{{ .Site.Params.version_url_prefix }}docs/images/oauth-edit.png" 
     alt="OAuth consent screen"
     class="mt-3 mb-3 p-3 border border-info rounded">
...
## Next steps
* [Set up your management cluster](/{{ .Site.Params.version_url_prefix }}docs/deploy/management-setup/).
